...
##### `__init__(self, gql_client: GraphQlClient, config: [ClientConfig](API-Types#clientconfig))`

##### `ask_question(self, copilot_id: str, question: str, thread_id: str, skip_report_cache: bool, dry_run_type: str, model_overrides: dict, indicated_skills: list[str], history: list[dict], question_type: [QuestionType](API-Types#questiontype), thread_type: [ThreadType](API-Types#threadtype)) -> [MaxChatEntry](API-Types#maxchatentry)`
...
- **question_type** ([QuestionType](API-Types#questiontype), optional): The type of question being asked. This is used to categorize the question and can determine how the UI chooses to display it.
- **thread_type** ([ThreadType](API-Types#threadtype), optional): The type of thread being created. This is used to categorize the thread and can determine how the UI chooses to display it.


**Returns:**

[MaxChatEntry](API-Types#maxchatentry) - The ChatEntry response object associated with the answer from the pipeline.

##### `add_feedback(self, entry_id: str, feedback_type: [FeedbackType](API-Types#feedbacktype), feedback_text: str) -> bool`
...
- **feedback_type** ([FeedbackType](API-Types#feedbacktype)): The type of feedback to add.
...
##### `get_threads(self, copilot_id: str, start_date: datetime, end_date: datetime) -> list[[MaxChatThread](API-Types#maxchatthread)]`
...
list[[MaxChatThread](API-Types#maxchatthread)] - A list of ChatThread objects.

##### `get_entries(self, thread_id: str, offset: int, limit: int) -> list[[MaxChatEntry](API-Types#maxchatentry)]`
...
list[[MaxChatEntry](API-Types#maxchatentry)] - A list of ChatEntry objects.

##### `evaluate_entry(self, entry_id: str, evals: list[str]) -> [EvaluateChatQuestionResponse](API-Types#evaluatechatquestionresponse)`
...
[EvaluateChatQuestionResponse](API-Types#evaluatechatquestionresponse) - The evaluation response object containing evaluation results.

##### `share_chat_thread(self, original_thread_id: str) -> [SharedThread](API-Types#sharedthread)`
...
[SharedThread](API-Types#sharedthread) - The shared thread object.

##### `get_chat_entry(self, entry_id: str) -> [MaxChatEntry](API-Types#maxchatentry)`
...
[MaxChatEntry](API-Types#maxchatentry) - The chat entry object.

##### `get_chat_thread(self, thread_id: str) -> [MaxChatThread](API-Types#maxchatthread)`
...
[MaxChatThread](API-Types#maxchatthread) - The chat thread object.

##### `create_new_thread(self, copilot_id: str, thread_type: [ThreadType](API-Types#threadtype)) -> [MaxChatThread](API-Types#maxchatthread)`
...
- **thread_type** ([ThreadType](API-Types#threadtype), optional): The type of thread to create. Defaults to CHAT. For most purposes CHAT is the only type needed.


**Returns:**

[MaxChatThread](API-Types#maxchatthread) - The newly created chat thread object.

##### `queue_chat_question(self, question: str, thread_id: str, skip_cache: bool, model_overrides: dict, indicated_skills: list[str], history: list[dict]) -> [MaxChatEntry](API-Types#maxchatentry)`
...
[MaxChatEntry](API-Types#maxchatentry) - A shell entry with an id you can use to query for the results.

##### `cancel_chat_question(self, entry_id: str) -> [MaxChatEntry](API-Types#maxchatentry)`
...
[MaxChatEntry](API-Types#maxchatentry) - The deleted entry.

##### `get_user(self, user_id: str) -> [MaxChatUser](API-Types#maxchatuser)`
...
[MaxChatUser](API-Types#maxchatuser) - A [MaxChatUser](API-Types#maxchatuser) object.

##### `get_all_chat_entries(self, offset, limit, filters) -> list[[MaxChatEntry](API-Types#maxchatentry)]`
...
##### `get_chat_artifact(self, chat_artifact_id: UUID) -> Optional[[ChatArtifact](API-Types#chatartifact)]`
...
[ChatArtifact](API-Types#chatartifact) or None - The chat artifact object if found, or `None` if not found or if an error occurs.

##### `get_chat_artifacts(self, search_input: Optional[ChatArtifactSearchInput], paging: Optional[PagingInput]) -> [PagedChatArtifacts](API-Types#pagedchatartifacts)`
...
[PagedChatArtifacts](API-Types#pagedchatartifacts) - A paged collection of chat artifacts. Returns an empty `[PagedChatArtifacts](API-Types#pagedchatartifacts)` instance if an error occurs during retrieval.

##### `create_chat_artifact(self, chat_artifact: [ChatArtifact](API-Types#chatartifact)) -> [MaxMutationResponse](API-Types#maxmutationresponse)`
...
- **chat_artifact** ([ChatArtifact](API-Types#chatartifact)): The chat artifact object containing the data to be created.


**Returns:**

[MaxMutationResponse](API-Types#maxmutationresponse) - The response object containing the result of the mutation, specifically the created chat artifact.

##### `delete_chat_artifact(self, chat_artifact_id: uuid) -> [MaxMutationResponse](API-Types#maxmutationresponse)`
...
[MaxMutationResponse](API-Types#maxmutationresponse) - The response object containing the result of the deletion mutation.
