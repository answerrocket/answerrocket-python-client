...
def query_get_copilot_skill():
    ...
    _op_get_copilot_skill_parameters.explorer_variable_id()
    _op_get_copilot_skill_parameters.key()
    ...
    _op_get_copilot_skill_parameters.inherited_value()
    _op_get_copilot_skill_parameters_note = _op_get_copilot_skill_parameters.note()
    _op_get_copilot_skill_parameters_note.copilot_note_id()
    _op_get_copilot_skill_parameters_note.text()
    _op_get_copilot_skill_parameters_note.created_user_id()
    _op_get_copilot_skill_parameters_note.created_utc()
    _op_get_copilot_skill_parameters_note.last_modified_user_id()
    _op_get_copilot_skill_parameters_note.last_modified_utc()
    _op_get_copilot_skill_parameters_note.version()
