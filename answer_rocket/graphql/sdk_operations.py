...
def fragment_chat_result_fragment():
    ...
    _frag_report_results_alt_visualizations = _frag_report_results.alt_visualizations()
    _frag_report_results_alt_visualizations.title()
    _frag_report_results_alt_visualizations.layout_json()
...
def mutation_queue_chat_question():
    ...
    _op_queue_chat_question = _op.queue_chat_question(thread_id=sgqlc.types.Variable('threadId'), question=sgqlc.types.Variable('question'), skip_cache=sgqlc.types.Variable('skipCache'), model_overrides=sgqlc.types.Variable('modelOverrides'), indicated_skills=sgqlc.types.Variable('indicatedSkills'), history=sgqlc.types.Variable('history'), pipeline_type=sgqlc.types.Variable('pipelineType'), request_source=sgqlc.types.Variable('requestSource'))
...
def mutation_run_copilot_skill_async():
    _op = sgqlc.operation.Operation(_schema_root.mutation_type, name='RunCopilotSkillAsync', variables=dict(copilotId=sgqlc.types.Arg(sgqlc.types.non_null(_schema.UUID)), skillName=sgqlc.types.Arg(sgqlc.types.non_null(_schema.String)), parameters=sgqlc.types.Arg(_schema.JSON), usePublishedVersion=sgqlc.types.Arg(_schema.Boolean), requestSource=sgqlc.types.Arg(_schema.RequestSource)))
    _op_run_copilot_skill_async = _op.run_copilot_skill_async(copilot_id=sgqlc.types.Variable('copilotId'), skill_name=sgqlc.types.Variable('skillName'), parameters=sgqlc.types.Variable('parameters'), use_published_version=sgqlc.types.Variable('usePublishedVersion'), request_source=sgqlc.types.Variable('requestSource'))
