...
def query_get_copilot_hydrated_reports():
    ...
    _op.get_copilot_hydrated_reports(copilot_id=sgqlc.types.Variable('copilotId'), override_dataset_id=sgqlc.types.Variable('overrideDatasetId'), load_all_skills=sgqlc.types.Variable('loadAllSkills'))
    return _op
