...
def query_get_copilot_hydrated_reports():
    ...
    _op_get_copilot_hydrated_reports_parameters_match_values_predicate_vocab = _op_get_copilot_hydrated_reports_parameters_match_values.predicate_vocab()
    _op_get_copilot_hydrated_reports_parameters_match_values_predicate_vocab.db_attr_name()
    _op_get_copilot_hydrated_reports_parameters_match_values_predicate_vocab.db_value()
    _op_get_copilot_hydrated_reports_parameters_match_values_predicate_vocab.nl_value()
    _op_get_copilot_hydrated_reports_parameters_match_values_predicate_vocab.preferred()
